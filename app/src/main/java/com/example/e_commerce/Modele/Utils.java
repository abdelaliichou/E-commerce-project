...
public class Utils {
    ...
    public static ArrayList<CategoryModel> list1, list;
    public static ArrayList<ItemsModel> list2, list3, list5, list4;
    ...
    public static ArrayList<CategoryModel> CategoriesList() {
        ...
        list1.clear();
        list1.add(new CategoryModel("Energy and endurance", "https://img.freepik.com/free-photo/young-sporty-man-concentrated-training-focused-athlete-looking-river-sunset-sportsman-preparing-running-fitness-healthy-lifestyle_342744-607.jpg?w=740&t=st=1685019006~exp=1685019606~hmac=b2a69c60773324b087e9386e78a998a9ad4db09dc779870620c351d94efab4a3"));
        list1.add(new CategoryModel("Herbal food supplements", "https://img.freepik.com/premium-photo/alternative-medicine-herbal-organic-capsule-with-vitamin-e-omega-3-fish-oil-mineral-drug-with-herbs-leaf-natural-supplements-healthy-good-life_39768-3472.jpg?w=740"));
        list1.add(new CategoryModel("Multivitamins", "https://img.freepik.com/free-photo/glass-fresh-fruit-juice_144627-17244.jpg?w=740&t=st=1685019337~exp=1685019937~hmac=75aa1ca79f08ccf809c5f3cf8570397bb12c671d2abe89c645a9b47c9f04482a"));
        list1.add(new CategoryModel("Nutrition sportive", "https://img.freepik.com/free-photo/sneakers-near-healthy-food_23-2147750792.jpg?w=740&t=st=1685019387~exp=1685019987~hmac=b721d550a5377eb1b731c90503db60bd76fb71176f8ce38b534eac54827b9a95"));
        list1.add(new CategoryModel("Sport nutrition", "https://img.freepik.com/free-photo/flat-lay-salad-weights_23-2148262144.jpg?w=740&t=st=1685019447~exp=1685020047~hmac=166b1cf654e134b90653ae064c9b275b2750d35641392682d54e75aade66a596"));
        return list1;
    }

    public static ArrayList<ItemsModel> initialPopularItemsList() {
        if (list2 == null) {
            list2 = new ArrayList<>();
        }
        list2.clear();
        list2.add(new ItemsModel("Optimum Nutrition Gold Standard Whey", "2000", "https://content.optimumnutrition.com/i/on/on-gold-standard-100-whey-protein_Image_01?$TTL_PRODUCT_IMAGES$&layer0=$PDP_004$&fmt=auto&img404=no-product-image&v=1&locale=en-us,en-gb,*", false));
        list2.add(new ItemsModel("MuscleBlaze Liquid L-Carnitine, 450 ml, Lemon Lime", "99.89", "https://img5.hkrtcdn.com/23182/prd_2318174-MuscleBlaze-Liquid-LCarnitine-450-ml-Lemon-Lime_o.jpg", false));
        list2.add(new ItemsModel("GEL30 Nitro Dual-Carb Energy Gel", "160.89", "https://cdn.shopify.com/s/files/1/0551/0388/1250/files/Gel30NitroWeb_700x.jpg?v=1685022967", false));
        list2.add(new ItemsModel("Nuun Sport Electrolyte Drink Tablets", "220.69", "https://cdn.shopify.com/s/files/1/0014/3563/1652/products/Tube-Single-w-tabs-Sport-StrawberryLemonade_x900.png?v=1648758046", false));
        list2.add(new ItemsModel("Bloom Nutrition Super Greens Powder", "97.94", "https://cdn.shopify.com/s/files/1/0143/0952/3556/products/Greens30_Berry_A.jpg?v=1680798061", false));
        list2.add(new ItemsModel("Garden of Life Vitamin Code", "2199.89", "https://www.gardenoflife.com/media/wysiwyg/vc-supplements-for-everybody-1060x1060_1_.jpg", false));
        list2.add(new ItemsModel("Optimum Nutrition Micronized Creatine Monohydrate Powder", "1700", "https://content.optimumnutrition.com/i/on/on-creatine-micronized_Image_01?$TTL_PRODUCT_IMAGES$&layer0=$PDP_004$&fmt=auto&img404=no-product-image&v=1&locale=en-us,en-gb,*", false));
        return list2;
    }
    ...
    public static ArrayList<ItemsModel> getPopularItemsListFromDataBase(String Category) {
    ...
    public static ArrayList<CategoryModel> getCategoriesListFromDataBase() {
        ...
        Rott.child("Users").child("Products").child("Categories").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot category : snapshot.getChildren()) {
                    CategoryModel model = category.getValue(CategoryModel.class);
                    list.add(model);
                }
            }
    ...
    public static ArrayList<ItemsModel> AllItemsList() {
        DatabaseReference Rott = FirebaseDatabase.getInstance().getReference();
        if (list4 == null) {
            list4 = new ArrayList<>();
        }
    ...
    public static ArrayList<ItemsModel> getFavoriteItems() {
        ...
        Rott.child("FavoriteItems").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot category : snapshot.getChildren()) {
                    ...
                    ItemsModel fav = category.getValue(ItemsModel.class);
                    boolean isDouble = false;
                    for (ItemsModel i : list5) {
                        if (i != null) {
    ...
    static public ArrayList<CardItemModel> getCardItemsList() {
        ArrayList<CardItemModel> liss = new ArrayList<>();
        ...
        head.child("UserCard").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot item : snapshot.getChildren()) {
                    CardItemModel model = item.getValue(CardItemModel.class);
                    liss.add(0, model);
        ...
        Root.child("FavoriteItems").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot i : snapshot.getChildren()) {
                    if (i.getValue(ItemsModel.class).getImageUrl() != null){
                        if (i.getValue(ItemsModel.class).getImageUrl().equals(uri)) {
                            existss = 1;
                            break;
                        }
                    }
