...
public class AllItemsAdapter_GridLayout extends RecyclerView.Adapter<AllItemsAdapter_GridLayout.ViewHolder> {

    public ArrayList<ItemsModel> items_list = new ArrayList<>();
    private Context context;
    int exists = 0;

    public AllItemsAdapter_GridLayout(ArrayList<ItemsModel> items_list, Context context) {
    ...
    @NonNull
    @Override
    public AllItemsAdapter_GridLayout.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.populair_item_gridlayout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllItemsAdapter_GridLayout.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
//         setting the hearts initial
        ...
        //Animations.Fromdowntoup(holder.card, position);
